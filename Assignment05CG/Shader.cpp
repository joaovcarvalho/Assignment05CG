...
char* Shader::readShaderSource(const char* shaderFile) {
	FILE* fp; //!->Why does binary flag "RB" work and not "R"... wierd msvc thing?
...
void Shader::CompileShaders()
{
	...
	AddShader(shaderProgramID, this->vertexShaderFile, GL_VERTEX_SHADER);
	AddShader(shaderProgramID, this->fragmentShaderFile, GL_FRAGMENT_SHADER);
